...
def gemini_inference(prompt:str) -> ToolCallResponseSchema:
    """
    Args:
        prompt (str): A prompt for the Gemini model to generate a response.
    Returns:
...
if __name__ == "__main__":
    gemini_inference("What is the current weather in Stuttgart?")
